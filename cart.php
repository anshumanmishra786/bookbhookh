      ...
      <div class="form-box">
               ...
               <div class="input-box mail">
                <p>Your cart info has been saved in our records! 
                    <br><br>
                    But since this is a project based website we didnt attach real book files but will surely bring this 
                    website to working condition. </p> <br><br>
                <p><u>Click below to return</u></p>
                <a href="index.php"><button type="button" class="login-btn click">H O M E</button></a>
